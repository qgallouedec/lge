...
class CNNCategoricalVAE(nn.Module):
    ...
    def __init__(
        ...
        self.linear1 = nn.Linear(256 * 5 * 5, self.nb_categoricals * self.nb_classes)

        # Decoder
        self.linear2 = nn.Linear(self.nb_categoricals * self.nb_classes, 256 * 5 * 5)
    ...
    def decode(self, x: Tensor) -> Tensor:
        ...
        x = F.relu(x)
        x = x.unflatten(-1, (256, 5, 5))  # [N x 256 x 5 x 5]
